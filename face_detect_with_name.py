# Youtube Tutorial - https://youtu.be/RrE7Ipr93SA..not work.
#not install wheel,dlib that's how it don't work and so face_recognition not install
#if dlib error.install command- pip install cmake,pip install dlib
import dlib
...
faces_path = "E:\face_detection\attendence"
